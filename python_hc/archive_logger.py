...
handlers = {logging.NOTSET: os.path.join(dir, 'notset_%s.log'%dir_time),
            ...
            logging.INFO: os.path.join(dir, 'archive.log'),

            logging.WARNING: os.path.join(dir, 'warning_%s.log'%dir_time),

            logging.ERROR: os.path.join(dir, 'archive.log'),
...
def createHandlers():
    ...
    for level in logLevels:
        ...
        handlers[level] = RotatingFileHandler(path, maxBytes=1024 * 1024 * 10, backupCount=20, encoding='utf-8')
